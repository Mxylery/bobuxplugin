...
public class MobAbilityManager {
    ...
    public static boolean verifyAbilityCD(BobuxMob bobuxMob, int index, Player player) {
        BobuxAbility ability = bobuxMob.getAbility(index);
    ...
    public static boolean verifyAbilityCD(BobuxMob bobuxMob, int index) {
        BobuxAbility ability = bobuxMob.getAbility(index);
        long cooldown = ability.getCooldown();
        long lastUse = bobuxMob.getAbilityHistory().checkForAbilityCD(ability, cooldown, bobuxMob.getEntity());
        ability.setOtherEntity(bobuxMob.getEntity());
